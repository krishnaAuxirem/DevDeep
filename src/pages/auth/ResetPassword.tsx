...
import { Zap, ArrowLeft, ArrowRight, Lock, CheckCircle2, Eye, EyeOff } from "lucide-react";
      ...
      <div className="max-w-md w-full mx-auto bg-white rounded-2xl border border-slate-200 p-8 shadow-xl space-y-6 animate-fade-in">
        <div className="space-y-2 text-center">
          ...
          <p className="text-xs text-slate-500 leading-relaxed">
            Please choose a strong passphrase for your DevDeep account {email && <span>(<strong className="text-slate-700 font-mono">{email}</strong>)</span>}.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-3 py-2.5 rounded-lg border border-slate-200 text-xs font-medium focus:outline-none focus:border-indigo-600 pr-10"
              />
              <button
                type="button"
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full px-3 py-2.5 rounded-lg border border-slate-200 text-xs font-medium focus:outline-none focus:border-indigo-600"
            />
          </div>
          ...
          >
            <span>{loading ? "Updating Credentials..." : "Update Password & Log In"}</span>
            <ArrowRight size={14} />
          </button>
        </form>
      </div>
